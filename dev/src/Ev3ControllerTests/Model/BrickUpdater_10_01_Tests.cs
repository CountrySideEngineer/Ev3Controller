...
{
    [TestClass()]
    public class BrickUpdater_10_01_Tests : Ev3Brick_TestBase
    {
        #region Unit test of BrickUpdater_10_01, update method
        [TestMethod()]
        [TestCategory("BrickUpdater_10_01")]
        [TestCategory("BrickUpdater_10_01_Update")]
        public void BrickUpdater_10_01_Update_Test_001()
        {
            ...
            var Updater = new BrickUpdater_10_01();
        ...
        [TestCategory("BrickUpdater_10_01")]
        [TestCategory("BrickUpdater_10_01_Update")]
        public void BrickUpdater_10_01_Update_Test_002()
        {
            var Command = new Command_10_01();
            Command.ResData = new byte[12];
